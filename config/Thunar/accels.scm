...
; (gtk_accel_path "<Actions>/ThunarBookmarks/54d1cdbedea8825bed650389fbd6be39" "")
...
; (gtk_accel_path "<Actions>/ThunarBookmarks/5a70d7e01d1d8342862fdd0104009e31" "")
...
(gtk_accel_path "<Actions>/ThunarActionManager/open-in-new-window" "<Primary><Shift>y")
