    ...
    delegate: Component {
	    ...
	    Connections {
            ...
            IpcHandler {
                ...
                function toggleBar() {
                    barWindow.barHidden = !barWindow.barHidden
                }
            }

            GlobalShortcut {
                name: "barToggle"
                description: "Toggles the top bar"
                onPressed: barWindow.barHidden = !barWindow.barHidden
            }
            ...
            visible: !barHidden
            height: barHidden ? 0 : barHeight
            margins { top: s(8); bottom: 0; left: s(4); right: s(4) }
            exclusiveZone: barHidden ? 0 : barHeight 
            color: "transparent"
