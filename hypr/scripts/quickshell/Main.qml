...
PanelWindow {
    ...
    IpcHandler {
        ...
        function handleCommand(cmd: string, targetWidget: string, arg: string): void {
            masterWindow.handleCommand(cmd, targetWidget, arg);
        }
    }
    ...
    function preloadWidget(name) {
        ...
        if (!t || !t.comp) return;
        let component = Qt.createComponent(Qt.resolvedUrl(t.comp));
        if (component.status === Component.Error) {
            console.error("Error creating component for " + t.comp + ": " + component.errorString());
            return;
        }
    ...
    function executeSwitch(newWidget, arg, immediate) {
        ...
        if (cached) {
            ...
            let obj = component.createObject(masterWindow, { "visible": false });
            if (obj) {
                if (obj.notifModel !== undefined) obj.notifModel = masterWindow.notifModel;
                if (obj.liveNotifs !== undefined) obj.liveNotifs = masterWindow.liveNotifs;
                if (obj.layoutWidth !== undefined) obj.layoutWidth = t.w;
                if (obj.layoutHeight !== undefined) obj.layoutHeight = t.h;
                if (newWidget === "wallpaper" && obj.widgetArg !== undefined) obj.widgetArg = arg;
