...
PanelWindow {
    ...
    FileView {
        ...
        watchChanges: true
        onFileChanged: dndWatcher.reload()
        onLoaded: popupWindow.dndEnabled = (dndWatcher.text().trim() === "1")
        onLoadFailed: popupWindow.dndEnabled = false
        Component.onCompleted: dndWatcher.reload()
    }
                        ...
                        RowLayout {
                            ...
                            Repeater {
                                ...
                                delegate: Rectangle {
                                    ...
                                    property string actionText: modelData.text || "Action"
                                    ...
                                    MouseArea {
                                        ...
                                        onClicked: {
                                            ...
                                            if (n && n.actions) {
                                                for (var i = 0; i < n.actions.length; i++) {
                                                    if (n.actions[i].identifier === actionButton.actionId) {
                                                        n.actions[i].invoke();
                                                        break;
                                                    }
                                                }
